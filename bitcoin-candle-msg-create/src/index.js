...
var readMarketPrice = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                urlBiticon = process.env.PRICES_API;
                if (!urlBiticon) return [3 /*break*/, 2];
                return [4 /*yield*/, axios_1.default.get(urlBiticon)];
            case 1:
                data = (_a.sent()).data;
                return [2 /*return*/, data.bitcoin.usd];
            case 2: return [2 /*return*/, 0];
        }
    });
}); };
exports.readMarketPrice = readMarketPrice;
var generateCandles = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, messageChannet_1.createMessageChannel)()];
            case 1:
            ...
            case 3:
                ...
                return [4 /*yield*/, (0, exports.readMarketPrice)()];
            case 4:
                price = _a.sent();
